...
net = CRinGeNet().cpu()
net.load_state_dict(torch.load("testCRinGe_Gaus_298n.cnn", map_location=lambda storage, loc: storage))
net.load_state_dict(torch.load("testCRinGe_Gaus_400n.cnn", map_location=lambda storage, loc: storage))
