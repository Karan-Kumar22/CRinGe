...
#            torch.nn.BatchNorm1d(3),
            torch.nn.Linear(3,30), torch.nn.LeakyReLU(),
            torch.nn.Linear(30,30), torch.nn.LeakyReLU()
        )
        ...
        self._mlp_E = torch.nn.Sequential(
            ...
            torch.nn.Linear(1,30), torch.nn.LeakyReLU(),
            torch.nn.Linear(30,30), torch.nn.LeakyReLU()
        )

        self._mlp = torch.nn.Sequential(
           # torch.nn.Linear(10, 1024), torch.nn.ReLU(),
           # torch.nn.Linear(10, 1024), torch.nn.ReLU(),
            torch.nn.Linear(120, 14784), torch.nn.LeakyReLU()
        )


        self._upconvs = torch.nn.Sequential(
            torch.nn.ConvTranspose2d(64, 64, 4, 2),  torch.nn.LeakyReLU(),
            torch.nn.Conv2d(64, 64, 3), torch.nn.LeakyReLU(),

            torch.nn.ConvTranspose2d(64, 32, 4, 2), torch.nn.LeakyReLU(),
            torch.nn.Conv2d(32, 32, 3),  torch.nn.LeakyReLU(),

            torch.nn.ConvTranspose2d(32, 32, 4, 2), torch.nn.LeakyReLU(),
            torch.nn.Conv2d(32, 3, 3)
        )

       # self._sigmoid = torch.nn.Sigmoid()
        self._leakyReLU = torch.nn.LeakyReLU()
    def forward(self, x) :
