...
for data in [ [[1, 0, 0, 0., 0., 0., 0., 0., 1., 200]],
    ...
    #to save event mu
    np.savetxt("eventMu_400node_"+str(i)+".txt", np.array(eventMu), fmt = "%s")
    ...
    #to save event Var
    np.savetxt("eventVariance_400node_"+str(i)+".txt", np.array(eventVariance), fmt = "%s")
    ...
    #to save hitproability event 
    np.savetxt("eventHitProb_400node_"+ str(i)+ ".txt", np.array(eventHitProb), fmt = "%s")
    ...
    #to save MuHitProb
    np.savetxt("eventMuHitProb_400node" + str(i)+ ".txt", np.array(eventMuHitProb), fmt = "%s")
